...
Plugin URI: http://www.hendrikbahr.de/
		...
		echo '
			...
			<li class="widget widget_links">
				...
				<a href="javascript:AddFavorite();"
					...
					<img src="/wp-content/plugins/hb-social-bookmarks/book_favorites.png" alt="Browser Favoriten" /></a>
				...
				<a href="http://www.mister-wong.de/?action=addurl&bm_url='.$url.'&bm_description='.$title.'"
					...
					src="/wp-content/plugins/hb-social-bookmarks/book_wong_16.gif" alt="Mr. Wong" /></a>
				...
				<a href="http://www.facebook.com/share.php" 
					...
					target="_blank"><img
					src="/wp-content/plugins/hb-social-bookmarks/book_facebook.gif" alt="Facebook" /></a>
				...
				<a href="http://www.stumbleupon.com/submit?url='.$url.'"
					...
					<img border=0 src="/wp-content/plugins/hb-social-bookmarks/book_su.gif" alt="StumbleUpon">
					</a>
				...
				<a href="http://www.technorati.com/faves/?add='.$url.'"
					...
					src="/wp-content/plugins/hb-social-bookmarks/book_technorati.png"
					alt="technorati" /></a>
				...
				<a href="http://furl.net/storeIt.jsp?u='.$url.'&t='.$title.'"
					...
					src="/wp-content/plugins/hb-social-bookmarks/book_furl.png" alt="Furl" /></a>
				...
				<a href="http://del.icio.us/post?url='.$url.'&title='.$title.'"
					...
					src="/wp-content/plugins/hb-social-bookmarks/book_delicious.png"
					alt="del.icio.us" /></a>
				...
				<a href="http://myweb2.search.yahoo.com/myresults/bookmarklet?u='.$url.'&t='.$title.'"
					...
					src="/wp-content/plugins/hb-social-bookmarks/book_yahoo.png" alt="yahoo" /></a>
				...
				<a href="http://www.linkarena.com/bookmarks/addlink/?url='.$url.'&title='.$title.'"
					...
					src="/wp-content/plugins/hb-social-bookmarks/book_linkarena.png" alt="Linkarena" /></a>
				...
				<a href="http://oneview.de/quickadd/neu/addBookmark.jsf?URL='.$url.'&title='.$title.'"
					...
					src="/wp-content/plugins/hb-social-bookmarks/book_oneview.png" alt="Oneview" /></a>
				...
				<a href="http://www.webnews.de"
					...
					<img src="/wp-content/plugins/hb-social-bookmarks/book_webnews.gif" alt="Webnews" /></a>
				...
				<a href="http://digg.com/submit?url='.$url.'&title='.$title.'&bodytext='.$description.'&media=news&topic=tech_news"
					...
					title="Digg it">
					<img src="/wp-content/plugins/hb-social-bookmarks/book_digg-16x16.png" width="16" height="16" alt="Digg!" />
					</a>
				...
				<a href="javascript: GetThis(\''.$title_iso.' \', \''.$description_iso.' \', \' '.$url.' \', 5)"
					...
					<img src="/wp-content/plugins/hb-social-bookmarks/book_myspace.gif" alt="MySpace" /></a>
				...
				<a href="https://favorites.live.com/quickadd.aspx?marklet=1&mkt=de&url='.$url.'&title='.$title.'&top=1"
					...
					<img src="/wp-content/plugins/hb-social-bookmarks/book_live.png" alt="Windows Live" /></a>
				...
				<a href="http://www.google.com/bookmarks/mark?op=add&hl=de&bkmk='.$url.'&title='.$title.'"
					...
					src="/wp-content/plugins/hb-social-bookmarks/book_google.png" alt="google" /></a>
				...
				<a href="http://www.folkd.com/submit/'.$url.'"
					...
					src="/wp-content/plugins/hb-social-bookmarks/book_folkd.png" alt="folkd" /></a>
				...
				<a href="http://www.blinklist.com/?Action=Blink/addblink.php&Url='.$url.'&Title='.$title.'&Tag=&Description='.$description.'"
					...
					src="/wp-content/plugins/hb-social-bookmarks/book_blinklist.png" alt="Blinklist" /></a>
				...
				<!-- Favoriten.de -->
					...
					<img src="/wp-content/plugins/hb-social-bookmarks/book_favoritende.gif" alt="Favoriten.de" border="0" /></a>
			</li>
		';
